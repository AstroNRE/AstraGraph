...
function nodeTone(nodeType: string): string {
  ...
  if (nodeType.startsWith("Entity") || nodeType.startsWith("Container") || nodeType.startsWith("Inventory") || nodeType.startsWith("Ui.") || nodeType.startsWith("Bui.")) return "entity";
