...
public static class UiHtmlPage
{
    ...
    public static string Render(UiDocument document)
    {
        ...
        page.Append("<!DOCTYPE html><html><head><meta charset=\"utf-8\"><title>")
            ...
            .Append("button { background: #3d4454; color: #f2f2f2; border: 1px solid #6d7690; padding: 6px 10px; cursor: pointer; }")
            .Append("button:hover { background: #556070; border-color: #d7deea; }")
            .Append("button:active, button.is-pressed { background: #243044; border-color: #edbc63; }")
            .Append("button:disabled, button:disabled:hover { background: #3d4454; border-color: #6d7690; cursor: default; }")
